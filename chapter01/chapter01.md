...
```text
(가정) 프로모션 행사를 기획하고자 하는데 누구 대상으로 어떤 카테고리의 상품으로 진행해야할까?
```
...
```text
1. 지난 3년 기준 가장 매출액이 크고 많이 팔린 상품의 카테고리는 어떤 것인가?
2. 주요 카테고리별 고객층의 연령대는 어떻게 되는가?
3. 연령대별 가장 많이 활용하는 결제 수단은 어떤거일까? --> 행사 기획 시 카드사와 연계하여 카드 할인 프로모션 진행
4. 
5. 
